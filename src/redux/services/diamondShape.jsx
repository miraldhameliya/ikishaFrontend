...
import { DIAMOND_SHAPE_LIST, DIAMOND_SHAPE_UPDATE, DIMOND_SHAPE, DIAMOND_SHAPE_STATUS_UPDATE, ALLWOP_SHAPE } from "../../api/constApi";
...
// ALLWOP_SHAPE
export const allWOPShape = async ({ page = 1, limit = 10, search = ''}) => {
   const payload = { page, limit, search };
      const response = await apiInstance.get(ALLWOP_SHAPE, { data: payload });
      return response.data;
}